...
(function ($) {
          ...
          onClick: function(evt) {
            ...
            if (wmslayers.length > 0) { 
              ...
              var params = {
                    ...
                    LAYERS: wmslayers,
                    Styles: '',
                    propertyName: Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_properties || null,
                    WIDTH: data.openlayers.size.w,
                    HEIGHT: data.openlayers.size.h,
                    format: 'image/png', // TODO parameterize this, like ...?
                    highlight: Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_highlight
                };
  ...
  Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.fillHTML = function(result) {
      if(Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_highlight &&
        Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_info_format == 'application/vnd.ogc.gml')
      {
          var reader = new OpenLayers.Format.GML();
          var features = reader.read(result);
          var layer = Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.hlLayer[0]
          layer.removeAllFeatures();
          for(var i = 0; i < features.length; i++)
          {
            Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.hlLayer[0].addFeatures([features[i]]);
